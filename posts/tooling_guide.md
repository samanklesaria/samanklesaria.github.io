...
- Use Python for scripting with the `uv` package manager. 
...
**LLMs:** 
- It's hard to beat Claude Code for AI assisted editing. Editor integration doesn't add anything; just use the CLI.
- Ollama makes it easy to manage local LLMs. I tend to use qwen. 
