...
library(reticulate)
reticulate::use_virtualenv(paste(getwd(), ".venv", sep = "/"), required = TRUE)
```
...
![png]({attach}SyntheticControl_files/SyntheticControl_13_0.png)
...
![png]({attach}SyntheticControl_files/SyntheticControl_33_0.png)
...
![png]({attach}SyntheticControl_files/SyntheticControl_46_0.png)
...
![png]({attach}SyntheticControl_files/SyntheticControl_50_0.png)
...
![png]({attach}SyntheticControl_files/SyntheticControl_52_0.png)
...
![png]({attach}SyntheticControl_files/SyntheticControl_57_0.png)
