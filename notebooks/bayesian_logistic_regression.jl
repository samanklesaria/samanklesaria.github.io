...
# ╔═╡ 2179cff9-0f1a-45cd-8a75-159506fd82e0
md"The following code averages the decision probability over quasi Monte Carlo samples of possible datasets we might observe if the true parameters are given by θ."
...
# ╔═╡ 5883ab8a-3721-4159-a05d-a4ec9af78907
md"We also need to average the decision probability over our prior for θ."
...
md"Now, we can use these quasi Monte Carlo estimates to approximate how many messages we'll be able to test for a given sample size."
