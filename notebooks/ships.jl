...
#> [frontmatter]
#> title = "Classifying Ships with Gausian Process Mixtures"
#> date = "2025-11-19"
...
# ╔═╡ 27736b13-a335-49ff-bd4e-b04dd7e1645f
...
# ╔═╡ 0f30091b-6f68-41c0-a526-be8091d3c68f
md"## The Model"
...
# ╔═╡ add45c66-be98-49b7-93c5-6c7dda99c027
...
# ╔═╡ 87f94596-93ce-4456-ab85-b5ed44381246
md"""
...
md"We can eliminate terms like $\psi(\sum_j \alpha _j)$ and $\log | \Lambda |$ which are the same for all components. The result is an expression for $q(z_i = k)$, which I'll write as $r_{ik}$."
...
# ╔═╡ cb06d510-67e9-4e0f-981e-3e3dbda61c8b
...
git-tree-sha1 = "0b75b447ee242254ff037402461e5593a84f9ac7"
...
[[deps.SizeCheck]]
deps = ["MLStyle"]
git-tree-sha1 = "33377279db1bc0e02559a15bd1637f126ff72487"
uuid = "e0176837-3861-45f9-8fb4-a12fc39b9661"
version = "0.1.0"
